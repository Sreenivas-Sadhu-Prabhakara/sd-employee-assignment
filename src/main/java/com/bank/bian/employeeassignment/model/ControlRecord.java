package com.bank.bian.employeeassignment.model;
...
/**
 * The BIAN control record for this service domain: "Employee Assignment Management Plan".
 *
 ...
 * to its asset type (Employee Assignment). Phase 1 keeps a generic, shallow shape;
...
public class ControlRecord {
    ...
    private final String controlRecordType = "Employee Assignment Management Plan";
